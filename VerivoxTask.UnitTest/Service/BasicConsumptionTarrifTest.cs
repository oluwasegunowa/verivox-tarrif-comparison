...
{
    public class BasicConsumptionTarrifTest
    {

        private int InvalidConsumption = -100;
        private int ValidConsumption = 3500;
        public BasicConsumptionTarrifTest()
        {
        ...
        {
            return MockDataSeed.GetBasicProducts().Where(s => s.Consumption == ValidConsumption).Select(s => new ProductDTO()
            {
